...
<script src="../resources/js/seatUseEnd.js"></script>
</head>
<body>
				...
				<tbody class="text-center">
					...
					<tr>
						<td>
							...
							%> <input type="checkbox" name="seatChk"
							value="<%=dto.getSeatId()%>" /> <%
 }
 %>
						</td>
            ...
            --%>
						...
						<td><%=dto.getUseStartTime()%></td>
						<td><%=dto.getUseEndSchedule()%></td>
						<td><%=dto.getUseEndTime() != null ? dto.getUseEndTime() : ""%></td>
