...
<body>
	...
	<form method="get">
		<table class="table" border="1" width="90%">
			...
			<tr>
				...
				<input type="date" name="searchWord2" />
			...
			<c:otherwise>
				<c:forEach items="${boardLists }" var="row" varStatus="loop">
					<tr align="center">
						...
						<td align="left"><a href="../board/view.do?idx=${row.bbsIdx}&boardId=10">${row.title }</a></td>
						<td>${row.memberNo }</td>
						<td>${row.regiDate }</td>
	...
	<table class="table" width="90%">
			<tr align="center">
			<td>${map.pagingImg }</td>
			<td width="100"><button type="button" class="btn btn-info">글쓰기</button></td>
			</tr>
		</table>
</div>
</body>
